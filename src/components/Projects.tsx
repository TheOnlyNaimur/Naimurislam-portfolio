...
import { getFeaturedProjects, getProjects, getProjectCategories } from "@/services/projectService";
import { 
  Carousel, 
  CarouselContent, 
  CarouselItem, 
...
const Projects = () => {
  ...
  const isLoading = featuredLoading || (allProjectsLoading && featuredProjects.length === 0);
  const showingAllProjects = featuredProjects.length === 0 && allProjects.length > 0;
      ...
      <div className="container mx-auto px-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-10">
            ...
            <p className="text-muted-foreground">Make sure to add some projects in the database.</p>
          </div>
        ) : (
          <>
            {showingAllProjects && (
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
                <p className="text-amber-800 dark:text-amber-200 mb-2">
                  <strong>Note:</strong> Showing all projects because no featured projects were found.
                </p>
                <Button 
                  variant="outline" 
                  size="sm"
